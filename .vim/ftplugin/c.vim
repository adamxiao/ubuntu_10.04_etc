...
" ---------- idioms menu  ----------------------------------------------------
"
 noremap    <buffer>  <silent>  <LocalLeader>igv        :call C_InsertTemplate("idioms.GetValue")<CR>
"vnoremap    <buffer>  <silent>  <LocalLeader>igv   <Esc>:call C_InsertTemplate("idioms.GetValue", "v")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>igv   <Esc>:call C_InsertTemplate("idioms.GetValue")<CR>
" added by adam, above
