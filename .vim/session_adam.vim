...
nmap <F8> :source ~/.vim/session_adam.vim
map <F7><F7> :cp
map <F7> :cn
map <F6><F6> :ccl
map <F6> :cw
...
set shortmess=aoO
badd +0 Public/Dropbox/work/tydic/crm20_c_config.sql
badd +0 Public/Dropbox/work/tydic/dic_551_config.sql
silent! argdel *
edit Public/Dropbox/work/tydic/crm20_c_config.sql
...
setlocal dictionary=
setlocal nodiff
setlocal equalprg=sql_format.py\ -
...
1
normal! 0
tabedit Public/Dropbox/work/tydic/dic_551_config.sql
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
